...
Nous citons enfin les outils suivants de "_Threat Risk Modeling"_ qui pourront vous aider à identifier et évaluer les scénarios de menaces dans le cadre de vos ateliers d'analyse de risque : base de sonnaissances EBIOS \([http://www.ssi.gouv.fr/entreprise/guide/ebios-2010-expression-des-besoins-et-identification-des-objectifs-de-securite/](http://www.ssi.gouv.fr/entreprise/guide/ebios-2010-expression-des-besoins-et-identification-des-objectifs-de-securite/)\), _Tactical Threat Modeling_ de SAFECode \([https://safecode.org/publications/](https://safecode.org/publications/)\), classification STRIDE de Microsoft \(\), métrique _Risk Rating Security Threats_ DREAD \(
